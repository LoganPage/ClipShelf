...
| 系统 | 直接下载 | 使用说明 |
|---|---|---|
| **Windows 10 / 11（x64）** | **[Windows 1.2.10 体验版 ZIP](https://github.com/LoganPage/ClipShelf/releases/download/windows-v1.2.10/ClipShelf-Windows-v1.2.10-public-x64.zip)** | [Windows 安装、使用与常见问题](Windows/README.md) |
...
[Windows 版本详情](https://github.com/LoganPage/ClipShelf/releases/tag/windows-v1.2.10) · [Mac 版本详情](https://github.com/LoganPage/ClipShelf/releases/tag/v1.2.0) · [全部历史版本](https://github.com/LoganPage/ClipShelf/releases) · [反馈问题](https://github.com/LoganPage/ClipShelf/issues)
...
按 **Space** 预览文字、图片、PDF、DOCX 或 PPTX。Excel 等其他格式显示说明和文件位置，可用默认应用打开。Word/PPT 为近似排版；Windows 当前是未签名体验版；可在“设置 → 版本与更新”中检查并安装新版，安装前备份历史与设置。
